...
> This post is inspired by the excellent [Multi-Agent as Tool](https://www.youtube.com/watch?v=wL4V78s_wI4&t=36s) tutorial by **[Rasmus Wulff Jensen](https://www.linkedin.com/in/rasmuswulffjensen/)** ([@rwj_dk](https://www.youtube.com/@rwj_dk)). His original sample uses Azure OpenAI — I ported the concept to Anthropic Claude to compare token usage across architectures. Check out his [GitHub repo](https://github.com/rwjdk/MicrosoftAgentFrameworkSamples) for the full collection of Microsoft Agent Framework tutorials.
