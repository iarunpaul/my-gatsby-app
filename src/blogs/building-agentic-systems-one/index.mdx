...
![MCP Inspector calling Hello tool](./Animation_Hello.gif)
...
<iframe 
  src="https://gist.github.com/iarunpaul/8eb6188538475ccaec445623d12c95f2.pibb"
  width="100%"
  height="800"
  frameBorder="1"
  scrolling="yes"
...
Yeppy! You just added a new tool and called it via Inspector.
The same works with any MCP-aware client, including LLMs (which we’ll cover in Part 2).
