...
---
{/* ![Alt text](./Part2-Title.png)

![Gif](./Animation_Hello.gif)

import Part2Title from './Part2-Title.png'
...
<ImageGallery 
  columns={3}
  images={[
    { src: Part2Title, alt: "Step 1", caption: "Setup" },
    { src: Part2Title, alt: "Step 2", caption: "Config" },
    { src: Part2Title, alt: "Step 3", caption: "Deploy" }
  ]}
/>
You can control image width, but you need to use HTML syntax instead of pure markdown. Here are the best approaches:
🎯 Quick Solutions:
Option 1: HTML Syntax with Inline Styles (Simple)
<img src={Part2Title} alt="Alt text" style={{width: "80%"}} />
Option 3: Responsive Width Control
<img 
  src={Part2Title}
  alt="Alt text"
  className="w-full md:w-3/4 lg:w-1/2 mx-auto block rounded-lg shadow-lg"
/>
Option 2: HTML with Tailwind Classes (Recommended)
<img src={Part2Title} alt="Alt text" className="w-3/4 mx-auto block" />  */}
